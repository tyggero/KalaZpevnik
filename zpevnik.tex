...
\addtolength{\hoffset}{-45pt}
\addtolength{\voffset}{-55pt}
...
\beginsong{Afričančata}[by={Jaromír Nohavica}]\hypertarget{song-4}{}\label{song-4}
\num
...
\beginsong{Africa}[by={Toto}]\hypertarget{song-5}{}\label{song-5}
\intro
\cseq{\[G] \[Hm]} \rep{4}
\cl
\chordsoff
...
\beginsong{Ahoj Peggy}[by={Kamelot}]\hypertarget{song-6}{}\label{song-6}
\num
...
\beginsong{Ahoj slunko}[by={Jaromír Nohavica}]\hypertarget{song-7}{}\label{song-7}
\emptyv
\cseq{\[C] \[F] \[G]}\\
\cl
\chordsoff
...
\beginsong{Andělé}[by={Wanastowi Vjecy}]\hypertarget{song-13}{}\label{song-13}
\num
...
\beginsong{Anděl}[by={Karel Kryl}]\hypertarget{song-14}{}\label{song-14}
\emptyv
...
\beginsong{A te Réhradice}[by={Moravská lidová (Vlasta Redl)}] \hypertarget{song-17}{}\label{song-17}
\num
...
\beginsong{Atlantida}[by={Miro Žbirka}]\hypertarget{song-18}{}\label{song-18}
\capo{2}
\num
...
\beginsong{A ty tam}[by={Mňága a Žďorp}]\hypertarget{song-19}{}\label{song-19}
\freev
...
\beginsong{Až se k nám právo vrátí}[by={Spirituál kvintet}]\hypertarget{song-20}{}\label{song-20}
\num
...
\beginsong{Až}[by={Tomáš Klus}]\hypertarget{song-21}{}\label{song-21}
\transpose{7}
\num
...
\beginsong{Bedna od whisky}[by={Hoboes}]\hypertarget{song-31}{}\label{song-31}
\num
...
\beginsong{Behind Blue Eyes}[by={Limp Bizkit}]\hypertarget{song-32}{}\label{song-32}
\capo{3}
...
\beginsong{Berousek}[by={Mňága a Žďorp}]\hypertarget{song-33}{}\label{song-33}
\intro
\cseq{\[C] \[F] \[Dm] \[C] \[G]}\\
\cl
\chordsoff
...
\beginsong{Bezpečné reggae}[by={Žamboši}]\hypertarget{song-34}{}\label{song-34}
\num
...
\beginsong{Bitva o Karlův most}[by={Michal Prokop}]\hypertarget{song-35}{}\label{song-35}
\num
...
\beginsong{Black Velvet Band}[by={The Dubliners}]\hypertarget{song-36}{}\label{song-36}
\num
...
\beginsong{Bláznova ukolébavka}[by={Pavel Dydovič}]\hypertarget{song-37}{}\label{song-37}
\num
...
\beginsong{Čarodějnice z Amesbury}[by={Asonance}]\hypertarget{song-52}{}\label{song-52}
\num
...
\beginsong{Čas}[by={Tomáš Klus}]\hypertarget{song-54}{}\label{song-54}
\emptyv
\cseq{\[Hm] \[G] \[D] \[A]}\\
\cl
\chordsoff
...
\beginsong{Černá díra}[by={Karel Plíhal}]\hypertarget{song-55}{}\label{song-55}
\num
...
\beginsong{Černej pasažér}[by={Traband}]\hypertarget{song-56}{}\label{song-56}
\num
...
\beginsong{Čert ví proč}[by={Zuzana Navarová}]\hypertarget{song-57}{}\label{song-57}
\transpose{7}
\num
...
\beginsong{Cesta}[by={Kryštof feat. Tomáš Klus}]\hypertarget{song-58}{}\label{song-58}
\emptyv
\cseq{\[C] \[G] \[Am] \[F] \[G]}\\
\cl
\chordsoff
...
\beginsong{Cestou do Jenkovic}[by={Radůza}]\hypertarget{song-59}{}\label{song-59}
...
\beginsong{Cesty Páně}[by={Mňága a Žďorp}]\hypertarget{song-60}{}\label{song-60}
\emptyv
\cseq{\[E] \[A] \[F\shrp{}m] \[H]}\\
\cl
\chordsoff
...
\beginsong{Chacha}[by={Jaromír Nohavica}]\hypertarget{song-61}{}\label{song-61}
\capo{3}
\chor
...
\beginsong{Chci zas v tobě spát}[by={Lucie}]\hypertarget{song-62}{}\label{song-62}
\transpose{7}
\intro
...
\beginsong{Choose a Side}[by={The Connells}]\hypertarget{song-63}{}\label{song-63}
\intro
\cseq{\[Hm] \[D] \[A] \[G]}\\
\cl
\chordsoff
...
\beginsong{Chtít chytit vítr}[by={Mňága a Ždorp}]\hypertarget{song-64}{}\label{song-64}
\capo{3}
\freev
...
\beginsong{Chůze}[by={Bratři Ebenové}]\hypertarget{song-65}{}\label{song-65}
\num
...
\beginsong{Chvíle}[by={Hop trop}]\hypertarget{song-66}{}\label{song-66}
\num
...
\beginsong{Cliché}[by={Support Lesbiens}]\hypertarget{song-67}{}\label{song-67}
\capo{4}
...
\beginsong{Co jste, hasiči}\hypertarget{song-68}{}\label{song-68}
\num
...
\beginsong{Co když}[by={Vlasta Redl}]\hypertarget{song-69}{}\label{song-69}
\num
\chordson
...
\beginsong{Colorado}[by={Kabát}]\hypertarget{song-70}{}\label{song-70}
\num
...
\beginsong{Co nadělám}[by={Devítka}]\hypertarget{song-71}{}\label{song-71}
\num
...
\beginsong{Co se to stalo, bratříčku}[by={Jaromír Nohavica}]\hypertarget{song-72}{}\label{song-72}
\pick{PI(MA)I}
...
\beginsong{Čtyři bytelný kola}[by={Greenhorns}]\hypertarget{song-73}{}\label{song-73}
\num
...
\beginsong{Cukrářská bosanova}[by={Jaromír Nohavica}]\hypertarget{song-74}{}\label{song-74}
...
\beginsong{Cyklistika}[by={Jaromír Nohavica}]\hypertarget{song-75}{}\label{song-75}
\capo{3}
\num
...
\beginsong{Ďábel a syn}[by={Kabát}]\hypertarget{song-76}{}\label{song-76}
\num
...
\beginsong{Dajána}[by={Paul Anka \& Zdeněk Borovec}]\hypertarget{song-77}{}\label{song-77}
\num
...
\beginsong{Dál, dál, dál}[by={Mňága a Žďorp}]\hypertarget{song-78}{}\label{song-78}
\capo{5}
\emptyv
...
\beginsong{Darmoděj}[by={Jaromír Nohavica}]\hypertarget{song-79}{}\label{song-79}
\num
...
\beginsong{David a Goliáš}[by={Jaroslav Ježek, Jiří Voskovec a Jan Werich}]\hypertarget{song-80}{}\label{song-80}
\averse
...
\beginsong{Dědečkovy hodiny}[by={Taxmeni}]\hypertarget{song-81}{}\label{song-81}
\num
...
\beginsong{Dej mi víc své lásky}[by={Olympic}]\hypertarget{song-82}{}\label{song-82}
\num
...
\beginsong{Dělání}[by={Svěrák a Uhlíř}]\hypertarget{song-83}{}\label{song-83}
\emptyv
\cseq{\[G] \[C] \[G] \[C]}\\
\cl
\chordsoff
...
\beginsong{Demáček}[by={Buty}]\hypertarget{song-84}{}\label{song-84}
\intro
\cseq{\[Am] \[F] \[C] \[Am] \[F] \[C]}\\
\cl
\chordsoff
...
\beginsong{Detaily}[by={Vypsaná fixa}]\hypertarget{song-85}{}\label{song-85}
\emptyv
\cseq{\[Hm] \[G] \[D] \[A]}\\
\cl
\chordsoff
...
\beginsong{Dětské šaty}[by={Petr Kalandra}]\hypertarget{song-86}{}\label{song-86}
\intro
...
\beginsong{Dezolát}[by={Vypsaná Fixa}]\hypertarget{song-87}{}\label{song-87}
\emptyv
\cseq{\[Em] \[C] \[D] \[A]}\\
\cl
\chordsoff
...
\beginsong{Disappointed}[by={The Connells}]\hypertarget{song-88}{}\label{song-88}
\intro
\chordsoff
...
\beginsong{Divokej horskej tymián}[by={Pavel Lohonka Žalman}]\hypertarget{song-89}{}\label{song-89}
\capo{3}
\num
...
\beginsong{Divoké koně}[by={Jaromír Nohavica}]\hypertarget{song-90}{}\label{song-90}
\num
...
\beginsong{Dlouhej kouř}[by={Chinaski}]\hypertarget{song-91}{}\label{song-91}
\emptyv
\cseq{\[D] \[C] \[G]}
\cl
\chordsoff
...
\beginsong{Dokud se zpívá}[by={Jaromír Nohavica}]\hypertarget{song-93}{}\label{song-93}
\num
...
\beginsong{Do nebe}[by={Tomáš Klus}]\hypertarget{song-94}{}\label{song-94}
\emptyv
\cseq{\[G] \[D] \[Em] \[C]}\\
\cl
\chordsoff
...
\beginsong{Do posledního dechu}[by={Nerez}]\hypertarget{song-99}{}\label{song-99}
\num
...
\beginsong{Doprdele prace}[by={Jaromír Nohavica}]\hypertarget{song-100}{}\label{song-100}
\emptyv
\cseq{\[Dm] \[G] \[B] \[A] \[Dm] \[A]}\\
\cl
\chordsoff
...
\beginsong{Do ticha}[by={Traband}]\hypertarget{song-101}{}\label{song-101}
\num
...
\beginsong{Dračí song}[by={LJH Chemik}]\hypertarget{song-102}{}\label{song-102}
\num
...
\beginsong{Drnová chajda}[by={Michal Tučný a Greenhorni}]\hypertarget{song-103}{}\label{song-103}
\num
...
\beginsong{Drobná paralela}[by={Chinaski}]\hypertarget{song-104}{}\label{song-104}
\num
\chordson
...
\beginsong{Duj duj duj}[by={Buty}]\hypertarget{song-105}{}\label{song-105}
\freev
...
\beginsong{Dva havrani}[by={Asonance}]\hypertarget{song-106}{}\label{song-106}
\num
\chordson
...
\beginsong{Dva roky prázdnin}[by={Karel Černoch}]\hypertarget{song-108}{}\label{song-108}
\averse
\chordson
...
\beginsong{Dva}[by={Zrní}]\hypertarget{song-109}{}\label{song-109}
\bridge
...
\beginsong{Dvě báby}[by={Spirituál kvintet}]\hypertarget{song-110}{}\label{song-110}
\num
...
\beginsong{Dvě ryby}[by={Chemik}]\hypertarget{song-111}{}\label{song-111}
\chorusi
...
\beginsong{Ej padá padá rosenka}[by={Blue Effect}]\hypertarget{song-112}{}\label{song-112}
\chordsoff
\intro\emptyspace\\\cl
\num
\chordson
...
\beginsong{El Condor Pasa}[by={Paul Simon \& Art Garfunkel}]\hypertarget{song-113}{}\label{song-113}
\num
...
\beginsong{Elektrický valčík}[by={Svěrák a Uhlíř}]\hypertarget{song-114}{}\label{song-114}
\num
...
\beginsong{Emo}[by={Vobezdud}]\hypertarget{song-115}{}\label{song-115}
...
\beginsong{Ešče si já pohár vína zaplatím}[by={Moravská lidová}]\hypertarget{song-116}{}\label{song-116}
\num
...
\beginsong{Ešče si já pohár vína zaplatím}[by={Moravská}]\hypertarget{song-117}{}\label{song-117}
\num
...
\beginsong{Ešče som sa něoženil}[by={Lidová}]\hypertarget{song-118}{}\label{song-118}
\num
...
\beginsong{Éterická}[by={UDG}]\hypertarget{song-119}{}\label{song-119}
\emptyv
\cseq{\[Dm] \[B] \[Am]}\\
\cl
\chordsoff
...
\beginsong{Ezop a brabenec}[by={Jaroslav Ježek, Jiří Voskovec a Jan Werich}]\hypertarget{song-120}{}\label{song-120}
\freev
...
\beginsong{Fajn džob}[by={Hop Trop}]\hypertarget{song-121}{}\label{song-121}
\num
...
\beginsong{Falling Slowly}[by={Frames}]\hypertarget{song-122}{}\label{song-122}
\capo{3}
\num
...
\beginsong{Feather on the Clyde}[by={Passenger}]\hypertarget{song-123}{}\label{song-123}
\capo{8}
\pick{P(IM)}
...
\beginsong{Fénix}[by={Nezmaři}]\hypertarget{song-124}{}\label{song-124}
\num
...
\beginsong{Fields of Athenry}[by={The Dubliners}]\hypertarget{song-125}{}\label{song-125}
\num
...
\beginsong{Fireflies}[by={Owl City}]\hypertarget{song-126}{}\label{song-126}
\capo{7}
\num
...
\beginsong{Fotbal}[by={Jaromír Nohavica}]\hypertarget{song-127}{}\label{song-127}
\num
...
\beginsong{Fram}[by={Wabi Daněk}]\hypertarget{song-128}{}\label{song-128}
\capo{3}
\num
...
\beginsong{Frankie Dlouhán}[by={Nedvědi}]\hypertarget{song-129}{}\label{song-129}
\num
...
\beginsong{František}[by={Buty}]\hypertarget{song-130}{}\label{song-130}
\intro
\cseq{\[G] \[C] \[G] \[C]}\\
\cl
\chordsoff
...
\beginsong{Fun and Games}[by={The Connells}]\hypertarget{song-131}{}\label{song-131}
\intro
\cseq{\[Em] \[G] \[D] \[C]}\\
\cl
\chordsoff
...
\beginsong{Gastrosexuál}[by={Wohnout}]\hypertarget{song-132}{}\label{song-132}
\chordsoff
\intro\emptyspace\\ \cl
\num
\chordson
...
\beginsong{Gaudeamus igitur}[by={Jaromír Nohavica}]\hypertarget{song-133}{}\label{song-133}
\num
...
\beginsong{Gorale}[by={Čechomor / Gentlemen Singers (lidová)}]\hypertarget{song-134}{}\label{song-134}
\num
\chordson
...
\beginsong{Grónská písnička}[by={Jaromír Nohavica}]\hypertarget{song-135}{}\label{song-135}
\num
...
\beginsong{Hallelujah}[by={Rufus Wainwright}]\hypertarget{song-136}{}\label{song-136}
\num
\chordson
...
\beginsong{Harfa}[by={Asonance}]\hypertarget{song-137}{}\label{song-137}
\num
...
\beginsong{Heidi}[by={Kamelot}]\hypertarget{song-138}{}\label{song-138}
\num
...
\beginsong{Hej, člověče Boží}[by={Nezmaři}]\hypertarget{song-139}{}\label{song-139}
\capo{3}
\num
\chordson
...
\beginsong{Hej, lidi}[by={Devítka}]\hypertarget{song-140}{}\label{song-140}
\capo{3}
\num
...
\beginsong{Hejna včel}[by={Brontosauři}]\hypertarget{song-141}{}\label{song-141}
\num
...
\beginsong{Hercegovina}\hypertarget{song-142}{}\label{song-142}
\num
...
\beginsong{Here Comes The Sun}[by={Beatles}]\hypertarget{song-143}{}\label{song-143}
\num
...
\beginsong{Hey Jude}[by={Beatles}]\hypertarget{song-144}{}\label{song-144}
\num
...
\beginsong{Hezká holka}[by={Mňága a Ždorp}]\hypertarget{song-145}{}\label{song-145}
\musicnote{akordy}
\emptyv
...
\beginsong{High and Dry}[by={Radiohead}]\hypertarget{song-146}{}\label{song-146}
\musicnote{E2 XX6454}
...
\beginsong{Hlásná Třebáň}[by={Ivan Mládek}]\hypertarget{song-147}{}\label{song-147}
\num
...
\beginsong{Hledání}[by={Jaroslav Samson Lenk}]  \hypertarget{song-148}{}\label{song-148}
\num
...
\beginsong{Hlídač krav}[by={Jaromír Nohavica}]\hypertarget{song-149}{}\label{song-149}
\emptyv
\cseq{\[C] \[F] \[G]}\\
\cl
\chordsoff
...
\beginsong{Hloupý a ztracený}[by={Mňága a Žďorp}]\hypertarget{song-150}{}\label{song-150}
\num
...
\beginsong{Hlupáku, najdu tě}[by={Svěrák \& Uhlíř}]\hypertarget{song-151}{}\label{song-151}
\num
...
\beginsong{Hodinový hotel}[by={Mňága a Žďorp}]\hypertarget{song-152}{}\label{song-152}
\emptyv
\cseq{\[C] \[Em] \[A] \[F] \[G]}
\cl\chordsoff\num
...
\beginsong{Holes}[by={Passenger}]\hypertarget{song-153}{}\label{song-153}
\capo{9}
\num
...
\beginsong{Holubí dům}[by={Jiří Schelinger}]\hypertarget{song-154}{}\label{song-154}
\num
...
\beginsong{Homo}[by={Tomáš Klus}]\hypertarget{song-155}{}\label{song-155}
\emptyv
\cseq{\[A] \[C\shrp{}m] \[D] \[E]}\\
\cl
\chordsoff
...
\beginsong{Honolulu}[by={Kamelot}]\hypertarget{song-156}{}\label{song-156}
\num
...
\beginsong{House of the Rising Sun}[by={Americká folková balada}]\hypertarget{song-157}{}\label{song-157}
\capo{2}
\num
...
\beginsong{Hrobař}[by={Premiěr}]\hypertarget{song-158}{}\label{song-158}
\num
...
\beginsong{Hruška}[by={Čechomor}]\hypertarget{song-159}{}\label{song-159}
\num
...
\beginsong{Hudsonské šífy}[by={Wabi Daněk}]\hypertarget{song-160}{}\label{song-160}
\num
...
\beginsong{Hurt}[by={Johnny Cash}]\hypertarget{song-161}{}\label{song-161}
\num
...
\beginsong{Husličky}[by={Vlasta Redl}]\hypertarget{song-162}{}\label{song-162}
\num
...
\beginsong{Hvězda na vrbě}[by={Olympic}]\hypertarget{song-163}{}\label{song-163}
\num
...
\beginsong{Hvězdář}[by={UDG}]\hypertarget{song-164}{}\label{song-164}
\emptyv
\cseq{\[G] \[D] \[Am] \[C]}
\cl\chordsoff\num
...
\beginsong{Hvězdný Ursus}[by={Skokan a Koumák}]\hypertarget{song-165}{}\label{song-165}
\num
...
\beginsong{Hvězdy nad hlavou}[by={Chinaski}]\hypertarget{song-166}{}\label{song-166}
\num
...
\beginsong{I cesta může být cíl}[by={Mňága a Žďorp}]\hypertarget{song-167}{}\label{song-167}
\emptyv
\cseq{\[F] \[C] \[B]}
\cl\chordsoff\num
...
\beginsong{Imagine}[by={John Lennon}]\hypertarget{song-170}{}\label{song-170}
\intro
...
\beginsong{Injekce morfia}[by={KSV}]\hypertarget{song-171}{}\label{song-171}
\emptyv
\cseq{\[C] \[F]}\\
\cl
\chordsoff
...
\beginsong{Inzerát}[by={Tomáš Klus}]\hypertarget{song-172}{}\label{song-172}
\emptyv
\cseq{\[G] \[D] \[Em] \[C]}\\
\cl
\chordsoff
...
\beginsong{Já na tom dělám}[by={Bratři Ebenové}]\hypertarget{song-177}{}\label{song-177}
\num
...
\beginsong{Já neumím}[by={Jaromír Nohavica}]\hypertarget{song-178}{}\label{song-178}
%\transpose{-2}
\num
...
\beginsong{Já písnička}[by={Pavlína Jíšová}]\hypertarget{song-179}{}\label{song-179}
\num
...
\beginsong{Já s tebou žít nebudu}[by={Nerez}]\hypertarget{song-185}{}\label{song-185}
...
\beginsong{Jestli to nebude láska}[by={Zdeněk Svěrák a Jaromír Uhlíř}]\hypertarget{song-196}{}\label{song-196}
\num
...
\beginsong{Kde trubka zní}[by={Petr Nejedlý}]\hypertarget{song-206}{}\label{song-206}
\num
...
\beginsong{Kdo vám tak zcuchal tmavé vlasy}[by={Hm}]\hypertarget{song-207}{}\label{song-207}
\emptyv
\cseq{\[D] \[F] \[B] \[C]}\\
\cl
\chordsoff
...
\beginsong{Kdyby}[by={Jaromír Nohavica}]\hypertarget{song-208}{}\label{song-208}
\num
...
\beginsong{Kdyby se v komnatách}[by={Zdeněk Svěrák a Jaromír Uhlíř}]\hypertarget{song-209}{}\label{song-209}
\num
...
\beginsong{Kdyby tady byla taková panenka}[by={Lidová / Jaroslav Lohonka Žalman}]\hypertarget{song-210}{}\label{song-210}
\num
...
\beginsong{Když je v Praze hic}[by={Ivan Mládek}]\hypertarget{song-211}{}\label{song-211}
\num
...
\beginsong{Když mě brali za vojáka}[by={Jaromír Nohavica}]\hypertarget{song-212}{}\label{song-212}
\num
...
\beginsong{Když náš táta hrál}[by={Greenhorns}]\hypertarget{song-213}{}\label{song-213}
\num
...
\beginsong{Kláda}[by={Hop trop}]\hypertarget{song-214}{}\label{song-214}
\num
...
\beginsong{Klára}[by={Chinaski}]\hypertarget{song-215}{}\label{song-215}
\bridge
...
\beginsong{Klobouk ve křoví}[by={Voskovec a Werich}]\hypertarget{song-216}{}\label{song-216}
\num
...
\beginsong{Kluziště}[by={Karel Plíhal}]\hypertarget{song-217}{}\label{song-217}
\pick{PIMA}
\num
\chordson
...
\beginsong{Knockin' on Heaven's Door}[by={Bob Dylan}]\hypertarget{song-218}{}\label{song-218}
\emptyv
\cseq{\[G] \[D] \[Am] \[G] \[D] \[C]}
\cl\chordsoff\num
...
\beginsong{Kočka na okně}[by={Jiří Suchý}]\hypertarget{song-219}{}\label{song-219}
\chor
...
\beginsong{Kočky}[by={Nerez}]\hypertarget{song-220}{}\label{song-220}
\capo{2}
...
\beginsong{Kohout}[by={Jan Nedvěd}]\hypertarget{song-221}{}\label{song-221}
\num
...
\beginsong{Kolej Yesterday}[by={Framus 5}]\hypertarget{song-222}{}\label{song-222}
\num
...
\beginsong{Kometa}[by={Jaromír Nohavica}]\hypertarget{song-223}{}\label{song-223}
\num
...
\beginsong{Koulí}[by={Cop}]\hypertarget{song-224}{}\label{song-224}
\num
...
\beginsong{Kozel}[by={Jaromír Nohavica}]\hypertarget{song-225}{}\label{song-225}
\num
...
\beginsong{Krajina posedlá tmou}[by={Jiří Suchý a Jiří Šlitr}]\hypertarget{song-226}{}\label{song-226}
\num
...
\beginsong{Králíci}[by={Karel Plíhal}]\hypertarget{song-227}{}\label{song-227}
\num
...
\beginsong{Královna z Dundrum Bay}[by={Nedvědi}]\hypertarget{song-228}{}\label{song-228}
\num
...
\beginsong{Krambambule}[by={Evropská studentská píseň, česky Aiva s Koblihou}]\hypertarget{song-229}{}\label{song-229}
\chordsoff\num
...
\beginsong{Krasojezdkyně}[by={Traband}]\hypertarget{song-230}{}\label{song-230}
\num
...
\beginsong{Kristián}[by={o5 and Radeček}]\hypertarget{song-231}{}\label{song-231}
\num
...
\beginsong{Kristínka}[by={Peter Nagy}]\hypertarget{song-232}{}\label{song-232}
\num
...
\beginsong{Kristy Are You Doing Okay}[by={The Offspring}]\hypertarget{song-233}{}\label{song-233}
\intro
\cseq{\[C] \[F] \[G]}\\
\cl
\chordsoff
...
\beginsong{Krtek}[by={Buty}]\hypertarget{song-234}{}\label{song-234}
\averse
...
\beginsong{Kryštof}[by={Kryštof}]\hypertarget{song-235}{}\label{song-235}
\num
...
\beginsong{Kryštof}[by={Minikapela UMSKUP}]\hypertarget{song-236}{}\label{song-236}
\capo{5}
\intro
\cseq{\[C] \[G] \[Am] \[F]}\\
\cl
...
\beginsong{Kurtizána}[by={UDG}]\hypertarget{song-237}{}\label{song-237}
\averse
...
\beginsong{Kutil}[by={Chinaski}]\hypertarget{song-238}{}\label{song-238}
\emptyv
\cseq{\[E] \[F\shrp{}m] \[A] \[E]}
\cl\chordsoff\num
Jsem kutil
...
\beginsong{Kým pri mne spíš}[by={Pavol Habera}]\hypertarget{song-239}{}\label{song-239}
\num
...
\beginsong{Kytka}[by={Brontosauři}]\hypertarget{song-240}{}\label{song-240}
\num
...
\beginsong{Laciný víno}[by={Jaroslav Samson Lenk}]\hypertarget{song-242}{}\label{song-242}
\num
...
\beginsong{Louvre}[by={Žamboši}]\hypertarget{song-259}{}\label{song-259}
\chordson
\beginverse
...
\beginsong{Love Is All Around}[by={Wet Wet Wet}]\hypertarget{song-261}{}\label{song-261}
\num
...
\beginsong{Maličký námořník}[by={Karel Plíhal}]\hypertarget{song-265}{}\label{song-265}
\num
...
\beginsong{Malování}[by={Divokej Bill}]\hypertarget{song-266}{}\label{song-266}
\intro
...
\beginsong{Mám jizvu na rtu}[by={Jaromír Nohavica}]\hypertarget{song-267}{}\label{song-267}
\num
...
\beginsong{Mamutí křik}[by={Nezmaři}]\hypertarget{song-268}{}\label{song-268}
\num
...
\beginsong{Mávátka}[by={Jaromír Nohavica}]\hypertarget{song-275}{}\label{song-275}
\num
...
\beginsong{Mercy Me}[by={Alkaline Trio}]\hypertarget{song-276}{}\label{song-276}
\emptyv
\cseq{\[C] \[Am] \[F]}\\
\cl
\chordsoff
...
\beginsong{Měsíc}[by={Mňága a Žďorp}]\hypertarget{song-277}{}\label{song-277}
\num
...
\beginsong{Metro pro krtky}[by={Jaromír Nohavica}]\hypertarget{song-278}{}\label{song-278}
\num
...
\beginsong{Mezi horami}[by={Čechomor}]\hypertarget{song-279}{}\label{song-279}
\num
...
\beginsong{Mikymauz}[by={Jaromír Nohavica}]\hypertarget{song-280}{}\label{song-280}
\pick{PIMAMIAM}
\num
...
\beginsong{Milenci v texaskách}[by={Starci na chmelu}]\hypertarget{song-281}{}\label{song-281}
\num
...
\beginsong{Mistr Mississippi}[by={KTO}]\hypertarget{song-282}{}\label{song-282}
\num
...
\beginsong{Mladičká básnířka}[by={Jaromír Nohavica}]\hypertarget{song-283}{}\label{song-283}
\num
...
\beginsong{Mlýny}[by={Spirituál kvintet}]\hypertarget{song-284}{}\label{song-284}
\chor
...
\beginsong{Montér blues}[by={Vlasta Redl}]\hypertarget{song-285}{}\label{song-285}
\num
...
\beginsong{Moonlight Shadow}[by={Mike Oldfield}]\hypertarget{song-286}{}\label{song-286}
\transpose{7}
\num
...
\beginsong{Morče za volantem}[by={Peshata}]\hypertarget{song-287}{}\label{song-287}
\emptyv
\cseq{\[Am] \[F] \[C] \[G]}\\
\cl
\chordsoff
...
\beginsong{Morituri te salutant}[by={Karel Kryl}]\hypertarget{song-288}{}\label{song-288}
\num
...
\beginsong{Morseovka}[by={Karel Plíhal}]\hypertarget{song-289}{}\label{song-289}
\num
...
\beginsong{Mravenčí ukolébavka}[by={Svěrák a Uhlíř}]\hypertarget{song-290}{}\label{song-290}
\num
...
\beginsong{Mrs. Robinson}[by={Simon \& Garfunkel}]\hypertarget{song-291}{}\label{song-291}
\intro
...
\beginsong{Muchomůrky bílé}[by={Milan Mejla Hlavsa}]\hypertarget{song-292}{}\label{song-292}
\num
...
\beginsong{Můj pes}[by={Jaromír Nohavica}]\hypertarget{song-293}{}\label{song-293}
\intro
\cseq{\[G] \[D] \[Em] \[D] \[C] \[D] \[G]}\\
\cl
\chordsoff
...
\beginsong{Mumie}[by={Slávek Janoušek}]\hypertarget{song-294}{}\label{song-294}
\averse
...
\beginsong{Můžem si za to oba}[by={Luboš Pospíšil}]\hypertarget{song-295}{}\label{song-295}
\num
...
\beginsong{Muzeum}[by={Jaromír Nohavica}]\hypertarget{song-296}{}\label{song-296}
\num
...
\beginsong{My Bonnie Lies Over the Ocean}\hypertarget{song-297}{}\label{song-297}
\num
...
\beginsong{Myš}[by={Jaroslav Hutka}]\hypertarget{song-298}{}\label{song-298}
\num
...
\beginsong{Myš na konci léta}[by={Jaromír Nohavica}]\hypertarget{song-299}{}\label{song-299}
\capo{3}
\num
...
\beginsong{Náchodský zámeček}[by={Lidová}]\hypertarget{song-300}{}\label{song-300}
\num
...
\beginsong{Nad stádem koní}[by={Buty}]\hypertarget{song-301}{}\label{song-301}
\emptyv
\cseq{\[D] \[A] \[Em] \[G]}
\cl\chordsoff\num
...
\beginsong{Nagasaki Hirošima}[by={Mňága a Žďorp}]\hypertarget{song-302}{}\label{song-302}
\num
...
\beginsong{Nahá v dešti}[by={Luboš Odháněl}]\hypertarget{song-303}{}\label{song-303}
\num
...
\beginsong{Námořnická}[by={Karel Plíhal}]\hypertarget{song-308}{}\label{song-308}
\num
...
\beginsong{Na ptáky jsme krátký}[by={Janek Ledecký}]\hypertarget{song-309}{}\label{song-309}
\chor
...
\beginsong{Na sever}[by={Kabát}]\hypertarget{song-310}{}\label{song-310}
\num
...
\beginsong{Nebe}[by={Anna K}]\hypertarget{song-313}{}\label{song-313}
%\transpose{2}
% \capo{2}
...
\beginsong{Nebe na zemi}[by={Jiří Voskovec, Jan Werich a Jaroslav Ježek}]\hypertarget{song-314}{}\label{song-314}
...
\beginsong{Nebezpečný síly}[by={Neřež}]\hypertarget{song-315}{}\label{song-315}
\intro
...
\beginsong{Něgdy}[by={Mňága a Žďorp}]\hypertarget{song-321}{}\label{song-321}
\num
...
\beginsong{Nehrálo se o ceny}[by={Hop trop}]\hypertarget{song-322}{}\label{song-322}
\num
...
\beginsong{Nejlíp jim bylo}[by={Mňága a Žďorp}]\hypertarget{song-323}{}\label{song-323}
\capo{3}
\emptyv
...
\beginsong{Nejvíc se Klára těší na neděli}[by={Mňága a Žďorp / JS dle Jakuba Navrátila}]\hypertarget{song-324}{}\label{song-324}
\capo{3}
...
\beginsong{Neklid}[by={Tomáš Klus}]\hypertarget{song-325}{}\label{song-325}
\emptyv
\cseq{\[C] \[E] \[Am] \[F]}
\cl\chordsoff\num
...
\beginsong{Některé otázky už si prostě nekladu}[by={Mňága a Žďorp}]\hypertarget{song-326}{}\label{song-326}
\capo{1}
\averse
...
\beginsong{Nenávratná}[by={Tomáš Klus}]\hypertarget{song-327}{}\label{song-327}
\emptyv
\cseq{\[G] \[D] \[C] \[Em] \[D]}\\
\cl
\chordsoff
...
\beginsong{Nevermore}[by={Jaromír Nohavica}]\hypertarget{song-328}{}\label{song-328}
\num
...
\beginsong{Nezacházej slunce}[by={Moravská lidová}]\hypertarget{song-329}{}\label{song-329}
\num
...
\beginsong{Nikdo to nebere}[by={Bratři Ebenové}]\hypertarget{song-330}{}\label{song-330}
\emptyv
\cseq{\[Em\hidx{7}] \[A]}\\
\cl
\chordsoff
...
\beginsong{Nikdy nic nebylo}[by={Sto zvířat}]\hypertarget{song-331}{}\label{song-331}
\emptyv
\cseq{\[Am] \[F] \[D] \[G]}
\cl\chordsoff\num
...
\beginsong{Nina}[by={Tomáš Klus}]\hypertarget{song-332}{}\label{song-332}
\emptyv
\cseq{\[G] \[Em] \[C] \[D]}\\
\cl
\chordsoff
...
\beginsong{Nosorožec}[by={Karel Plíhal}]\hypertarget{song-333}{}\label{song-333}
\num
...
\beginsong{Odpočiň si, Sáro}[by={Druhá tráva}]\hypertarget{song-334}{}\label{song-334}
\num
...
\beginsong{Oh Freedom}[by={Spirituál kvintet}]\hypertarget{song-335}{}\label{song-335}
\num
...
\beginsong{Okno mé lásky}[by={Olympic}]\hypertarget{song-336}{}\label{song-336}
\num
...
\beginsong{Omnia vincit Amor}[by={Klíč}]\hypertarget{song-338}{}\label{song-338}
\num
...
\beginsong{One of Us}[by={Joan Osborne}]\hypertarget{song-339}{}\label{song-339}
\capo{2}
\emptyv
\cseq{\[Em] \[C] \[G] \[D]}\\
\cl
...
\beginsong{Only You}[by={Flying Pickets}]\hypertarget{song-340}{}\label{song-340}
\bridge
...
\beginsong{Ooh La}[by={The Kooks}]\hypertarget{song-341}{}\label{song-341}
\emptyv
\cseq{\[Am] \[F] \[Dm]}\\
\cl
\chordsoff
...
\beginsong{Opatrujte vaše děti}\hypertarget{song-342}{}\label{song-342}
\emptyv
\cseq{\[Em] \[C] \[Am] \[D]}\\
\cl
\chordsoff
...
\beginsong{Outsider waltz}[by={Wabi Daněk}]\hypertarget{song-343}{}\label{song-343}
\num
...
\beginsong{O znakoplavkách a tak}[by={Žamboši}]\hypertarget{song-344}{}\label{song-344}
\num
...
\beginsong{Paměť stromů}[by={Bedřich Ludvík}]\hypertarget{song-345}{}\label{song-345}
\num
...
\beginsong{Panenka}[by={Poutníci}]\hypertarget{song-346}{}\label{song-346}
\num
...
\beginsong{Panenka}[by={Tomáš Klus}]\hypertarget{song-347}{}\label{song-347}
\capo{3}
\num
...
\beginsong{Papírové řetězy}[by={Wabi Daněk}]\hypertarget{song-348}{}\label{song-348}
\capo{3}
\num
...
\beginsong{Pár minut}[by={Cop}]\hypertarget{song-349}{}\label{song-349}
\chorusi
...
\beginsong{Patient Love}[by={Passenger}]\hypertarget{song-350}{}\label{song-350}
\capo{6}
\emptyv
\cseq{\[Am] \[F] \[C] \[G]}\\
\cl
...
\beginsong{Perfect Day}[by={Lou Reed}]\hypertarget{song-351}{}\label{song-351}
\num
...
\beginsong{Petěrburg}[by={Jaromír Nohavica}]\hypertarget{song-352}{}\label{song-352}
\num
...
\beginsong{Pijte vodu}[by={Jaromír Nohavica}]\hypertarget{song-353}{}\label{song-353}
\chor
...
\beginsong{Ping-pong}[by={Wabi Daněk}]\hypertarget{song-354}{}\label{song-354}
\num
...
\beginsong{Písek}[by={Nezmaři}]\hypertarget{song-355}{}\label{song-355}
\num
...
\beginsong{Píseň, co mě učil listopad}[by={Wabi Daněk}]\hypertarget{song-356}{}\label{song-356}
\num
...
\beginsong{Píseň lásky}[by={Chemik}]\hypertarget{song-357}{}\label{song-357}
\intro
\cseq{\[C] \[G] \[C] \[C] \[G]}\\
\cl
\chordsoff
...
\beginsong{Píseň malých pěšáků}[by={Pavel Lohonka Žalman}]\hypertarget{song-358}{}\label{song-358}
\num
...
\beginsong{Píseň pro malou Lenku}[by={Jaromír Nohavica}]\hypertarget{song-359}{}\label{song-359}
...
\beginsong{Píseň zhrzeného trampa}[by={Jaromír Nohavica}]\hypertarget{song-360}{}\label{song-360}
\num
...
\beginsong{Pískající cikán}[by={Spirituál Kvintet}]\hypertarget{song-361}{}\label{song-361}
\num
...
\beginsong{Písnička pro tebe}[by={Mňága a Žďorp}]\hypertarget{song-362}{}\label{song-362}
\num
...
\beginsong{Pochod marodů}[by={Jaromír Nohavica}]\hypertarget{song-363}{}\label{song-363}
\num
...
\beginsong{Pocit}[by={Buty}]\hypertarget{song-364}{}\label{song-364}
...
\beginsong{Pocity}[by={Tomáš Klus}]\hypertarget{song-365}{}\label{song-365}
\emptyv
\cseq{\[G] \[D] \[Em] \[C]}\\
\cl
\chordsoff
...
\beginsong{Pod dubem}[by={Zdeněk Svěrák a Jaromír Uhlíř}]\hypertarget{song-366}{}\label{song-366}
\chor
...
\beginsong{Podvod}[by={Jan Nedvěd}]\hypertarget{song-367}{}\label{song-367}
\capo{3}
\num
...
\beginsong{Pohádka}[by={Karel Plíhal}]\hypertarget{song-368}{}\label{song-368}
\intro
...
\beginsong{Pohár a kalich}[by={Klíč}]\hypertarget{song-369}{}\label{song-369}
\num
...
\beginsong{Pohoda}[by={Kabát}]\hypertarget{song-370}{}\label{song-370}
\intro
\cseq{\[D] \[A] \[E] \[Hm]}\\
\cl
\chordsoff
...
\beginsong{Pojď dál a zpívej}[by={Pavel Bobek}]\hypertarget{song-371}{}\label{song-371}
\capo{1}
\intro
\cseq{\[G] \[C] \[D\hidx{7}] \[C]}\\
\cl
...
\beginsong{Pole s bavlnou}[by={Spirituál kvintet}]\hypertarget{song-372}{}\label{song-372}
\num
...
\beginsong{Popel žhne}[by={Mňága a Žďorp}]\hypertarget{song-373}{}\label{song-373}
\capo{3}
\num
...
\beginsong{Pořád ta samá}[by={Tomáš Klus}]\hypertarget{song-374}{}\label{song-374}
\averse
...
\beginsong{Po schodoch}[by={Richard Müller}]\hypertarget{song-375}{}\label{song-375}
\num
...
\beginsong{Poutník a dívka (Ráchel)}[by={Spirituál Kvintet}]\hypertarget{song-376}{}\label{song-376}
\num
...
\beginsong{Pramínek vlasů}[by={Jiří Suchý a Jiří Šlitr}]\hypertarget{song-377}{}\label{song-377}
\num
...
\beginsong{Pražce}[by={Pavel Dobeš}]\hypertarget{song-378}{}\label{song-378}
\num
...
\beginsong{Předměstí}[by={UDG}]\hypertarget{song-379}{}\label{song-379}
\emptyv
\cseq{\[E] \[A]}\\
\cl
\chordsoff
...
\beginsong{Přičichnutí alergikovo}[by={Tomáš Klus}]\hypertarget{song-380}{}\label{song-380}
\averse
...
\beginsong{Přítel}[by={Jaromír Nohavica}]\hypertarget{song-381}{}\label{song-381}
...
\beginsong{Ptáčata}[by={Brontosauři}]\hypertarget{song-388}{}\label{song-388}
\num
...
\beginsong{Pyšný Janek}[by={Jaromír Nohavica}]\hypertarget{song-389}{}\label{song-389}
\num
...
\beginsong{Raci v práci}[by={Kabát}]\hypertarget{song-390}{}\label{song-390}
...
\beginsong{Ráda se miluje}[by={Karel Plíhal}]\hypertarget{song-391}{}\label{song-391}
\chor
...
\beginsong{Rakety}[by={Jaromír Nohavica}]\hypertarget{song-392}{}\label{song-392}
...
\beginsong{Rána v trávě}[by={Pavel Lohonka Žalman}]\hypertarget{song-393}{}\label{song-393}
\chor
...
\beginsong{Ráno bylo stejný}[by={Nezmaři}]\hypertarget{song-394}{}\label{song-394}
\num
...
\beginsong{Řekněte mamce prokrista}[by={Balada pro banditu}]\hypertarget{song-395}{}\label{song-395}
\num
...
\beginsong{Rocket Man}[by={Elton John}]\hypertarget{song-396}{}\label{song-396}
\num
...
\beginsong{Rodné lány}[by={Mňága a Žďorp}]\hypertarget{song-397}{}\label{song-397}
\num
\chordsoff
...
\beginsong{Rosa na kolejích}[by={Wabi Daněk}]\hypertarget{song-398}{}\label{song-398}
...
\beginsong{Ruby}[by={Pavel Bobek}]\hypertarget{song-399}{}\label{song-399}
\num
...
\beginsong{Runaway}[by={The Kooks}]\hypertarget{song-400}{}\label{song-400}
\emptyv
\cseq{\[Em] \[Hm] \[D] \[G]}\\
\cl
\chordsoff
...
\beginsong{Runaway Train}[by={Soul Asylum}]\hypertarget{song-401}{}\label{song-401}
\emptyv
\cseq{\[C] \[Em] \[Am] \[G]}\\
\cl
\chordsoff
...
\beginsong{Růže z papíru}[by={Nedvědi}]\hypertarget{song-402}{}\label{song-402}
\num
...
\beginsong{Růžička}[by={Spirituál kvintet}]\hypertarget{song-403}{}\label{song-403}
\num
...
\beginsong{Sametová}[by={Žlutej pes}]\hypertarget{song-404}{}\label{song-404}
\num
...
\beginsong{Samurajský meče}[by={Vypsaná fixa}]\hypertarget{song-405}{}\label{song-405}
\emptyv
...
\beginsong{Sáro!}[by={Traband}]\hypertarget{song-406}{}\label{song-406}
\chorusi
...
\beginsong{Sbohem galánečko}[by={Moravská lidová (Vlasta Redl)}]\hypertarget{song-407}{}\label{song-407}
\num
...
\beginsong{Scarborough Fair}[by={Paul Simon a Art Garfunkel}]\hypertarget{song-408}{}\label{song-408}
\num
...
\beginsong{Seaside}[by={The Kooks}]\hypertarget{song-409}{}\label{song-409}
\capo{1}
\num
...
\beginsong{Sedmnáct dnů}[by={Jiří Wabi Ryvola}]\hypertarget{song-410}{}\label{song-410}
\num
...
\beginsong{Sen}[by={Lucie}]\hypertarget{song-411}{}\label{song-411}
\num
...
\beginsong{Seňore}[by={Druhá tráva}]\hypertarget{song-412}{}\label{song-412}
\num
...
\beginsong{Seventy-Four, Seventy-Five}[by={The Connells}]\hypertarget{song-414}{}\label{song-414}
\num
...
\beginsong{Seventy-Four, Seventy-Five}[by={The Connels}]\hypertarget{song-415}{}\label{song-415}
\num
\[F]Got no \[C]reason for \[F]coming to me
Through the \[C]rain \[G]running \[F]down
There's no \[C]reason    \[Am]
...
\beginsong{Šibenice}[by={Divokej Bill}]\hypertarget{song-416}{}\label{song-416}
\num
...
\beginsong{Šípková Růženka}[by={Jiří Schelinger}]\hypertarget{song-417}{}\label{song-417}
\num
...
\beginsong{Škoda 1000 MB}[by={Slávek Janoušek}]\hypertarget{song-420}{}\label{song-420}
\num
...
\beginsong{Slavíci z Madridu}[by={Waldemar Matuška}]\hypertarget{song-421}{}\label{song-421}
\bridge
...
\beginsong{Slib}[by={Kamelot}]\hypertarget{song-422}{}\label{song-422}
\intro
...
\beginsong{Slzy tvý mámy}[by={Olympic}]\hypertarget{song-423}{}\label{song-423}
\num
...
\beginsong{Smuteční marše}[by={Druhá tráva}]\hypertarget{song-424}{}\label{song-424}
\num
...
\beginsong{Smutné a lehké}[by={UDG}]\hypertarget{song-425}{}\label{song-425}
\emptyv
\cseq{\[Em] \[C] \[G] \[D]}\\
\cl
\chordsoff
...
\beginsong{Smutno je mi}[by={Vlasta Redl}]\hypertarget{song-426}{}\label{song-426}
\num
...
\beginsong{Snad jsem to zavinil já}[by={Olympic}]\hypertarget{song-427}{}\label{song-427}
\num
...
\beginsong{Sound of Silence}[by={Paul Simon \& Art Garfunkel}]\hypertarget{song-430}{}\label{song-430}
\num
...
\beginsong{Sovy v mazutu}[by={František Sahula}]\hypertarget{song-431}{}\label{song-431}
\num
...
\beginsong{Spaste svoje duše}[by={Mňága a Žďorp}]\hypertarget{song-432}{}\label{song-432}
\num
...
\beginsong{Správná pětka}[by={Zvlášňý škola}]\hypertarget{song-433}{}\label{song-433}
\num
...
\beginsong{Šrouby do hlavy}[by={Lucie}]\hypertarget{song-434}{}\label{song-434}
\num
...
\beginsong{Stanice Jiřího z Poděbrad}[by={Jaromír Nohavica}] \hypertarget{song-435}{}\label{song-435}
\chordson
\beginverse
...
\beginsong{Stánky}[by={Nedvědi}]\hypertarget{song-436}{}\label{song-436}
\num
...
\beginsong{Star of the County Down}[by={Irská lidová (verze Irish Rovers)}]\hypertarget{song-438}{}\label{song-438}
\num
...
\beginsong{Starosta}[by={No Name}]\hypertarget{song-439}{}\label{song-439}
\num
...
\beginsong{Starý dům}[by={Listolet}]\hypertarget{song-440}{}\label{song-440}
\emptyv
\cseq{\[Em] \[G] \[D] \[Em]}\\
\cl
\num
...
\beginsong{Starý muž}[by={Jaromír Nohavica}]\hypertarget{song-441}{}\label{song-441}
\capo{5}
\num
...
\beginsong{Starý příběh}[by={Spirituál kvintet}]\hypertarget{song-442}{}\label{song-442}
\num
...
\beginsong{Statistika}[by={Zdeněk Svěrák a Jaromír Uhlíř}]\hypertarget{song-443}{}\label{song-443}
\num
...
\beginsong{Stejně jako já}[by={Chinaski}]\hypertarget{song-444}{}\label{song-444}
\num
...
\beginsong{Sto kroků samoty}[by={Jarret}]\hypertarget{song-445}{}\label{song-445}
\intro
...
\beginsong{Stop Crying Your Heart Out}[by={Oasis}]\hypertarget{song-446}{}\label{song-446}
...
\beginsong{Střízlivý maturant}[by={Chemik}]\hypertarget{song-447}{}\label{song-447}
...
\beginsong{Stromy}[by={Wabi Daněk}]\hypertarget{song-448}{}\label{song-448}
\num
...
\beginsong{Strýček Jack}[by={Americká lidová, text Jiří Voskovec a Jan Werich}]\hypertarget{song-449}{}\label{song-449}
\num
...
\beginsong{Studený nohy}[by={Radůza}]\hypertarget{song-450}{}\label{song-450}
\num
...
\beginsong{Stýskání}[by={Bratři Ebenové}]\hypertarget{song-451}{}\label{song-451}
...
\beginsong{Sunday, Bloody Sunday}[by={U2}]\hypertarget{song-452}{}\label{song-452}
\averse
...
\beginsong{Sundej z hodin závaží}[by={Michal Tučný a Fešáci}]\hypertarget{song-453}{}\label{song-453}
\num
...
\beginsong{Svatební}[by={Jaromír Nohavica}]\hypertarget{song-454}{}\label{song-454}
\emptyv
\cseq{\[D] \[A] \[G] \[A]}
\cl\chordsoff\num
...
\beginsong{Tabáček}[by={Chinaski}]\hypertarget{song-456}{}\label{song-456}
\averse
...
\beginsong{Table for One}[by={Passenger}]\hypertarget{song-457}{}\label{song-457}
\num
...
\beginsong{Tajný plán}[by={Mňága a Žďorp}]\hypertarget{song-458}{}\label{song-458}
\emptyv
...
\beginsong{Taking Pictures of You}[by={The Kooks}]\hypertarget{song-459}{}\label{song-459}
\capo{3}
\emptyv
\cseq{\[G] \[Em] \[Hm]}\\
\cl
...
\beginsong{Tak už mi má holka mává}\hypertarget{song-460}{}\label{song-460}
\num
...
\beginsong{Tereza}[by={Hoboes}]\hypertarget{song-461}{}\label{song-461}
\num
...
\beginsong{Těšínská}[by={Jaromír Nohavica}]\hypertarget{song-462}{}\label{song-462}
\num
...
\beginsong{The Biplane Evermore}[by={The Irish Rovers}]\hypertarget{song-463}{}\label{song-463}
\intro
\cseq{\[C] \[Am] \[C] \[Am]}\\
\cl
\chordsoff
...
\beginsong{Tichý muž}[by={Traband}]\hypertarget{song-464}{}\label{song-464}
...
\beginsong{Times They Are A-Changing}[by={Bob Dylan}]\hypertarget{song-465}{}\label{song-465}
\num
...
\beginsong{Tisíc dnů mezi námi}[by={Nerez}]\hypertarget{song-466}{}\label{song-466}
\averse
...
\beginsong{Tomáš}[by={Kamelot}]\hypertarget{song-467}{}\label{song-467}
\num
...
\beginsong{To tá Heľpa}[by={Slovenská}]\hypertarget{song-468}{}\label{song-468}
\num
...
\beginsong{Toulavej}[by={Vojta Tomáško}]\hypertarget{song-469}{}\label{song-469}
\num
...
\beginsong{Tři čuníci}[by={Jaromír Nohavica}]\hypertarget{song-470}{}\label{song-470}
\num
...
\beginsong{Tři kříže}[by={Hop trop}]\hypertarget{song-471}{}\label{song-471}
\num
...
\beginsong{Tři sudičky}[by={Jaromír Nohavica}]\hypertarget{song-472}{}\label{song-472}
\emptyv
\cseq{\[G] \[D] \[C] \[D] \[G]}\\
\cl
\chordsoff
...
\beginsong{Tulácký ráno}[by={Nedvědi}]\hypertarget{song-474}{}\label{song-474}
\num
...
\beginsong{Ukolébavka pro Kubu a Lenku}[by={Jaromír Nohavica}]\hypertarget{song-475}{}\label{song-475}
\averse
...
\beginsong{Ukolíbafka}[by={Hm}]\hypertarget{song-476}{}\label{song-476}
\num
...
\beginsong{Už to nenapravím}[by={Jaroslav Samson Lenk}]\hypertarget{song-477}{}\label{song-477}
\capo{1}
\chordsoff\chor
Vap tada dap\ldots
\cl\chordson\averse
...
\beginsong{Valčík na rozloučenou}[by={Taxmeni}]\hypertarget{song-478}{}\label{song-478}
\num
...
\beginsong{Válečná}[by={Tomáš Klus}]\hypertarget{song-479}{}\label{song-479}
\emptyv
\cseq{\[Hm] \[A] \[G] \[F\shrp{}]}\\
\cl
\chordsoff
...
\beginsong{Válka růží}[by={Spirituál kvintet}]\hypertarget{song-480}{}\label{song-480}
\emptyv
...
\beginsong{Vandrovní}[by={Jaroslav Samson Lenk}]\hypertarget{song-481}{}\label{song-481}
\num
...
\beginsong{Variace na renesanční téma}[by={Vladimír Mišík}]\hypertarget{song-482}{}\label{song-482}
\emptyv
\cseq{\[Am] \[F] \[G] \[Am]}
\cl\chordsoff\num
...
\beginsong{Včelín}[by={Čechomor}]\hypertarget{song-483}{}\label{song-483}
\num
...
\beginsong{Ve 4 ráno}[by={Mňága a Žďorp}]\hypertarget{song-484}{}\label{song-484}
\num
...
\beginsong{Večerky}[by={Mňága a Žďorp}]\hypertarget{song-485}{}\label{song-485}
\num
...
\beginsong{Večerní}[by={Karel Plíhal a Jaromír Nohavica}]\hypertarget{song-486}{}\label{song-486}
\num
...
\beginsong{Veď mě dál, cesto má}[by={Pavel Bobek}]\hypertarget{song-487}{}\label{song-487}
\num
...
\beginsong{Veličenstvo Kat}[by={Karel Kryl}]\hypertarget{song-488}{}\label{song-488}
\num
...
\beginsong{Velká voda}[by={Jaromír Nohavica}]\hypertarget{song-489}{}\label{song-489}
\emptyv
\cseq{\[Am] \[C] \[Dm] \[E]}\\
\cl
\chordsoff
...
\beginsong{Velrybářská výprava}[by={Pacifik}]\hypertarget{song-490}{}\label{song-490}
\num
...
\beginsong{Venku zuří jaro}[by={Jarret}]\hypertarget{song-491}{}\label{song-491}
\num
...
\beginsong{VeSmíru}[by={Tomáš Klus}]\hypertarget{song-493}{}\label{song-493}
\num
...
\beginsong{Větříček}[by={Čechomor}]\hypertarget{song-494}{}\label{song-494}
\averse
...
\beginsong{Vínečko bílé}[by={Moravská lidová}]\hypertarget{song-495}{}\label{song-495}
\num
...
\beginsong{Vizovice}[by={Fleret}]\hypertarget{song-496}{}\label{song-496}
\averse
...
\beginsong{Vlakem na Kolín}[by={Neřež}]\hypertarget{song-497}{}\label{song-497}
\num
...
\beginsong{Vlaštovko, leť}[by={Jaromír Nohavica}]\hypertarget{song-498}{}\label{song-498}
\pick{PIMAMI}
\num
...
\beginsong{Vlaštovky}[by={Traband}]\hypertarget{song-499}{}\label{song-499}
\num
...
\beginsong{V moři je místa dost}[by={Jaromír Nohavica}]\hypertarget{song-500}{}\label{song-500}
\chor
...
\beginsong{V myčce}[by={Hm}]\hypertarget{song-501}{}\label{song-501}
\intro
...
\beginsong{Vodácká holka}[by={Jaroslav Samson Lenk}]\hypertarget{song-502}{}\label{song-502}
\averse
...
\beginsong{Voda živá}[by={Aneta Langerová}]\hypertarget{song-503}{}\label{song-503}
\intro
\cseq{\[G] \[D] \[G] \[D]}\\
\cl
\chordsoff
...
\beginsong{Vosa}[by={Karel Plíhal}]\hypertarget{song-504}{}\label{song-504}
\num
...
\beginsong{V pořádku}[by={Nerez}]\hypertarget{song-505}{}\label{song-505}
\emptyv
...
\beginsong{Vstávej, holka}[by={Karel Plíhal}]\hypertarget{song-506}{}\label{song-506}
\num
...
\beginsong{Výhledově}[by={Mňága a Žďorp}]\hypertarget{song-507}{}\label{song-507}
\emptyv
\cseq{\[G] \[C] \[Em] \[D]}\\
\cl
\chordsoff
...
\beginsong{Vyšla luna bílá}[by={Francouzská lidová}] \hypertarget{song-508}{}\label{song-508}
\num
...
\beginsong{What Shall We Do With the Drunken Sailor}[by={Irská lidová (verze Irish Rovers)}]\hypertarget{song-509}{}\label{song-509}
\num
...
\beginsong{What You're Thinking}[by={Passenger}]\hypertarget{song-510}{}\label{song-510}
\capo{3}
\emptyv
\cseq{\[Em] \[C] \[G] \[D]}\\
\cl
...
\beginsong{Whiskey in the Jar}[by={The Dubliners}]\hypertarget{song-511}{}\label{song-511}
\capo{2}
\num
...
\beginsong{Wind of Change}[by={Scorpions}]\hypertarget{song-512}{}\label{song-512}
\capo{4}
\intro
...
\beginsong{Wish You Were Here}[by={Pink Floyd}]\hypertarget{song-513}{}\label{song-513}
\capo{3}
\intro\emptyspace\\ \cl
\chordsoff
\averse
...
\beginsong{Wonderwall}[by={Oasis}]\hypertarget{song-514}{}\label{song-514}
\intro
...
\beginsong{Yesterday}[by={Beatles}]\hypertarget{song-515}{}\label{song-515}
\num
...
\beginsong{You and I}[by={Wilco (feat. Feist)}]  \hypertarget{song-516}{}\label{song-516}
...
\beginsong{Your Song}[by={Elton John}]\hypertarget{song-517}{}\label{song-517}
\capo{3}
\begin{textblock}{1.5}(10.5,0)\noindent 
...
\beginsong{Zabili, zabili}[by={Balada pro banditu}]\hypertarget{song-518}{}\label{song-518}
\num
...
\beginsong{Zachraňte koně}[by={Kamelot}]\hypertarget{song-519}{}\label{song-519}
\intro
...
\beginsong{Zafúkané}[by={Fleret}]\hypertarget{song-520}{}\label{song-520}
...
\beginsong{Zahrada ticha}[by={Pavel Roth}]\hypertarget{song-521}{}\label{song-521}
\num
...
\beginsong{Zahrádka}[by={Epy de Mye}]\hypertarget{song-522}{}\label{song-522}
\num
...
\beginsong{Zajíci}[by={Jaromír Nohavica}]\hypertarget{song-523}{}\label{song-523}
\num
...
\beginsong{Zanedbaný sex}[by={Elán}]\hypertarget{song-524}{}\label{song-524}
\emptyv
\cseq{\[C] \[Dm] \[F] \[G]}\\
\cl
\chordsoff
...
\beginsong{Za svou pravdou stát}[by={Spirituál kvintet}]\hypertarget{song-525}{}\label{song-525}
\num
...
\beginsong{Zatanči}[by={Jaromír Nohavica}]\hypertarget{song-526}{}\label{song-526}
\emptyv
\cseq{\[Em] \[G] \[D] \[Em]}\\
\cl
\chordsoff
...
\beginsong{Zatímco se koupeš}[by={Jaromír Nohavica}]\hypertarget{song-527}{}\label{song-527}
...
\beginsong{Zatracenej život}[by={Greenhorns}]\hypertarget{song-528}{}\label{song-528}
\num
...
\beginsong{Za tři čtvrtě století}[by={Karel Plíhal}]\hypertarget{song-529}{}\label{song-529}
\num
...
\beginsong{Zdálo sa ně zdálo}[by={Čechomor}]\hypertarget{song-530}{}\label{song-530}
\intro
\cseq{\[Am] \[G] \[D]}
\cl\num
...
\beginsong{Zdá sa, že to stačí}[by={Zuzana Smatanová}]\hypertarget{song-531}{}\label{song-531}
\intro
\cseq{\[G] \[C] \[G] \[C]}\\
\cl
\chordsoff
...
\beginsong{Zejtra mám}[by={Ready Kirken}]\hypertarget{song-532}{}\label{song-532}
%\capo{3} at g
\num
...
\beginsong{Želva}[by={Olympic}]\hypertarget{song-533}{}\label{song-533}
\num
...
\beginsong{Země antilop}[by={Kamelot}]\hypertarget{song-534}{}\label{song-534}
\intro
...
\beginsong{Ženy mužů}[by={Epy de Mye}]\hypertarget{song-535}{}\label{song-535}
\capo{5}
\num
...
\beginsong{Žily}[by={No Name}]\hypertarget{song-536}{}\label{song-536}
\num
...
\beginsong{Zítra ráno v pět}[by={Jaromír Nohavica}]\hypertarget{song-537}{}\label{song-537}
\num
...
\beginsong{Život a čas}[by={Mňága a Žďorp}]\hypertarget{song-538}{}\label{song-538}
\emptyv
\cseq{\[Em] \[G] \[C] \[D]}\\
\cl
\chordsoff
...
\beginsong{Žízeň}[by={Spirituál kvintet}]\hypertarget{song-539}{}\label{song-539}
\num
...
\beginsong{Zmrzlinář}[by={Marsyas}]\hypertarget{song-540}{}\label{song-540}
...
\beginsong{Zpod větrných mlýnů}[by={Marien}]\hypertarget{song-541}{}\label{song-541}
\capo{2}
% \intro
...
\beginsong{Zůstat tam, kde jsem}[by={Slávek Janoušek}]\hypertarget{song-542}{}\label{song-542}
\num
...
\beginsong{Zvědavá}[by={UDG}]\hypertarget{song-543}{}\label{song-543}
\transpose{-2}
\num
...
\beginsong{Zvěrokruh}[by={Jarret}]\hypertarget{song-544}{}\label{song-544}
\num
