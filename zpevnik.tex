...
\beginsong{Mezi horami}[by={Čechomor}]\hypertarget{song-26}{}\label{song-26}
\num
...
\beginsong{Musíš bejt na sebe tvrdej}[by={Minikapela}]\hypertarget{song-27}{}\label{song-27}
\intro
\chordsoff
...
\beginsong{Nagasaki Hirošima}[by={Mňága a Žďorp}]\hypertarget{song-28}{}\label{song-28}
\num
...
\beginsong{Nebezpečný síly}[by={Neřež}]\hypertarget{song-29}{}\label{song-29}
\intro
...
\beginsong{Neklid}[by={Tomáš Klus}]\hypertarget{song-30}{}\label{song-30}
\emptyv
\cseq{\[C] \[E] \[Am] \[F]}
\cl\chordsoff\num
...
\beginsong{Nikdy nic nebylo}[by={Sto zvířat}]\hypertarget{song-31}{}\label{song-31}
\emptyv
\cseq{\[Am] \[F] \[D] \[G]}
\cl\chordsoff\num
...
\beginsong{Nina}[by={Tomáš Klus}]\hypertarget{song-32}{}\label{song-32}
\emptyv
\cseq{\[G] \[Em] \[C] \[D]}\\
\cl
\chordsoff
...
\beginsong{O Habartovi z Lopaty}[by={Demophobia}]\hypertarget{song-33}{}\label{song-33}
\chor
...
\beginsong{Petěrburg}[by={Jaromír Nohavica}]\hypertarget{song-34}{}\label{song-34}
\num
...
\beginsong{Pocity}[by={Tomáš Klus}]\hypertarget{song-35}{}\label{song-35}
\emptyv
\cseq{\[G] \[D] \[Em] \[C]}\\
\cl
\chordsoff
...
\beginsong{Proměny}[by={Čechomor}]\hypertarget{song-36}{}\label{song-36}
\num
...
\beginsong{Rád chodím na poštu}[by={Pokáč}]\hypertarget{song-37}{}\label{song-37}
\chor
...
\beginsong{Ráda se miluje}[by={Karel Plíhal}]\hypertarget{song-38}{}\label{song-38}
\chor
...
\beginsong{Řiditel autobusu}[by={The Tap Tap}]\hypertarget{song-39}{}\label{song-39}
\num
...
\beginsong{Sáro!}[by={Traband}]\hypertarget{song-40}{}\label{song-40}
\chorusi
...
\beginsong{Skautská Večerka}[by={Skautské písně}]\hypertarget{song-41}{}\label{song-41}
\num
\chordsoff
...
\beginsong{Slavíci z Madridu}[by={Waldemar Matuška}]\hypertarget{song-42}{}\label{song-42}
\bridge
...
\beginsong{Sound of Silence}[by={Simon a Garfunkel}]\hypertarget{song-43}{}\label{song-43}
\num
...
\beginsong{Studený nohy}[by={Radůza}]\hypertarget{song-44}{}\label{song-44}
\num
...
\beginsong{Tak dej groš zaklínači}[by={Joey Batey}]\hypertarget{song-45}{}\label{song-45}
\musicnote{CAPO I.}
\num
...
\beginsong{Tisíc dnů mezi námi}[by={Nerez}]\hypertarget{song-46}{}\label{song-46}
\averse
...
\beginsong{To samo}[by={Jananas}]\hypertarget{song-47}{}\label{song-47}
\intro
...
\beginsong{Trampská}[by={Bratři Ebenové}]\hypertarget{song-48}{}\label{song-48}
\num
...
\beginsong{Už to nenapravím}[by={Jaroslav Samson Lenk}]\hypertarget{song-49}{}\label{song-49}
\capo{1}
\chordsoff\chor
Vap tada dap\ldots
\cl\chordson\averse
...
\beginsong{V myčce}[by={Hm}]\hypertarget{song-50}{}\label{song-50}
\intro
...
\beginsong{V pořádku}[by={Nerez}]\hypertarget{song-51}{}\label{song-51}
\emptyv
...
\beginsong{Vlaštovky}[by={Traband}]\hypertarget{song-52}{}\label{song-52}
\num
...
\beginsong{Zase se budím}[by={Pavel Čadek}]\hypertarget{song-53}{}\label{song-53}
\chorusii
Zase se \[Dm]{ budím}
...
\beginsong{Zatanči}[by={Jaromír Nohavica}]\hypertarget{song-54}{}\label{song-54}
\emptyv
\cseq{\[Em] \[G] \[D] \[Em]}\\
\cl
\chordsoff
...
\beginsong{Zmrzlinář}[by={Marsyas}]\hypertarget{song-55}{}\label{song-55}
